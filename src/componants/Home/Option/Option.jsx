...
const Option = ({ selectedOption, checkedHandle, disable }) => {
    ...
    return (
        <div className='border border-2 h-full border-orange-500   flex  items-center gap-3 py-2 md:py-4 px-1 rounded-lg duration-300 hover:bg-orange-500 hover:text-white'>
